                                ...
                                >
                                                ...
                                                <img
                                                    ...
                                                    onError={(e) => {
                                                        (
                                                            ...
                                                            "https://placehold.co/150?text=No+Photo";
                                                        (
                                                            e.target as HTMLImageElement
                                    ...
                                    <td className="p-4 text-sm">
                                        <a
                                            ...
                                            target="_blank"
                                            rel="noopener noreferrer"
                                            className="inline-flex items-center px-3 py-1.5 rounded-lg bg-blue-500 text-white text-xs font-medium hover:bg-blue-600 transition-colors"
                                        >
                                            View Location
                                        </a>
                                    </td>
